        ...
        <>
            <div className='container-fluid p-5'>
                ...
                <div className='add_button'>
                    <Link to="/insertproduct" className='btn btn-primary fs-5'> + Add New Product</Link>
                </div>
                                    ...
                                    return (
                                        <>
                                            <tr key={element.id}>
                                                ...
                                                <td><Link to={`/updateproduct/${element._id}`} className="btn btn-primary"><i className="fa-solid fa-pen-to-square"></i></Link></td>
